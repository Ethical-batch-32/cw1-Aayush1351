...
<body>
  ...
  <a href="user.php"><img src="image/logo.png" alt=""></a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav" style="padding-left: 65%;">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active" style="font-size: 100%;" aria-current="page" href="index.php">Home</a>
        </li>
        <li class="nav-item">
        <a class="nav-link" href="#"> About us</a>
        </li>
        <li class="nav-item">
        <a class="nav-link" href="login/login.php">Connect with us</a>
        </li>
